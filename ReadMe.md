...
## What I have learnt:
* Excel and data basics - I mastered the fundamentals of data organization, formatting and essential formulas to transform raw numbers into clean, usable spreadsheets.
* Python/ Google Colab - I wrote clean code in an easy to use online environment to automate repetitive tasks and analyze large datasets without complex setup.
